...
In line with van Aken~\cite{van_aken_management_2004}, our visual abstract template emphaƒsizes technological rules as the main takeaway of design science within software engineering research. A technological rule can be expressed in the form: 
...
A design science research study creates new knowledge by investigating one or more instances of a solution in context~\cite{wieringa_what_2014} through action research (i.e., within one context)~\cite{wieringa_technical_2012}, through multiple case studies (i.e., across contexts)~\cite{van_aken_management_2004}, or through design cycles~\cite{gregor_positioning_2013}. Each instantiation (i.e., a case study or an iteration of action research) constitutes a unit of analysis in relation to that rule and the new knowledge is communicated and assessed from that perspective. 
