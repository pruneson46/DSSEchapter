...
As mentioned above, the typical research methodology used to study and test design propositions is multiple case studies. In multiple case studies, a series of problems of the same class are addressed. Design knowledge is built up through the empirical validation of the solution in context. %The case study methodology is well established in software engineering \cite{Runeson12Case} and fits  well into the design science paradigm. 
