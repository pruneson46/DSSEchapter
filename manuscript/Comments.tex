...
\item \per{Technological rule/design proposition}
\item \per{Which of Wieringa/Hevner references should be cited for what? I propose we change the reference from wireinga_what to the whole book. Ok?}
\end{itemize}
\section*{----------------------- REVIEW 1 ---------------------}
